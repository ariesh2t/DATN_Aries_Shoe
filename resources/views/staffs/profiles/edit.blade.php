...
<nav aria-label="breadcrumb" class="col-6">
    <ol class="breadcrumb justify-content-end">
      ...
      <li class="breadcrumb-item"><a href="{{ route('staff.profile') }}">{{ __('profile') }}</a></li>
...
<div class="container-xl px-4 mt-4">
    <hr class="mt-0 mb-4">
    <form action="{{ route('staff.profile.update') }}" method="POST" id="form-profile" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                ...
                <div class="card-body text-center">
                    <div class="mb-3 form-group aform-upload">
                        <div class="aform-upload__preview justify-content-center">
                            <div class="aform-upload__item col-12">

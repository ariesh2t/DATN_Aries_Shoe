...
class StoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'cost.min' => __('min', ['attr' => __('cost'), 'value' => 1000]),
            'cost.max' => __('max', ['attr' => __('cost'), 'value' => 1000000000]),
            'price.required' => __('required', ['attr' => __('price')]),
            'price.numeric' => __('numeric', ['attr' => __('price')]),
            'price.min' => __('min', ['attr' => __('price'), 'value' => 1000]),
            'price.max' => __('max', ['attr' => __('price'), 'value' => 1000000000]),
            'promotion.required' => __('required', ['attr' => __('promotion')]),
            'promotion.numeric' => __('numeric', ['attr' => __('promotion')]),
            'promotion.min' => __('min', ['attr' => __('promotion'), 'value' => 1000]),
            'promotion.max' => __('max', ['attr' => __('promotion'), 'value' => 1000000000]),
